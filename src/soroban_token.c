...
static const soroban_token_t tokens[] = {
    ...
    {{
         0xf5, 0xd6, 0x36, 0xb3, 0xc8, 0xd7, 0xcc, 0x6e, 0xe1, 0x13, 0xc4,
         0x9b, 0x9a, 0xe0, 0x9d, 0x7b, 0x6a, 0x1c, 0xee, 0xb3, 0x30, 0x52,
         0xf3, 0x01, 0x21, 0xa9, 0xd2, 0x89, 0xe6, 0x66, 0x27, 0x53,
     },
     "BLND"},
    ...
    {{
         0x17, 0xe2, 0x47, 0x53, 0x47, 0x85, 0x38, 0x83, 0x1e, 0x09, 0x6f,
         0x66, 0xd8, 0x1f, 0xb4, 0xf1, 0x7a, 0x5e, 0x70, 0x11, 0xe8, 0x11,
         0x20, 0x34, 0xeb, 0xbc, 0xa6, 0x6c, 0xe9, 0x29, 0xbd, 0x9f,
     },
     "CETES"},
    ...
    {{
         0xe6, 0xa7, 0xd9, 0xeb, 0x75, 0x23, 0x00, 0x6a, 0x46, 0x9a, 0xa7,
         0x48, 0x3a, 0xd1, 0x10, 0x72, 0x47, 0x44, 0x3c, 0x0d, 0x82, 0xe6,
         0x27, 0x63, 0xde, 0x67, 0x08, 0x48, 0xc4, 0xe9, 0x7c, 0x90,
     },
     "EURC"},
    ...
    {{
     ...
     "LSP"},
    // CDHG3SIDGBS4A4ZEV55DYRBUVBJGQVUSNQ2U34BHMFJUVBKLCUOUD6YT
    {{
         0xce, 0x6d, 0xc9, 0x03, 0x30, 0x65, 0xc0, 0x73, 0x24, 0xaf, 0x7a,
         0x3c, 0x44, 0x34, 0xa8, 0x52, 0x68, 0x56, 0x92, 0x6c, 0x35, 0x4d,
         0xf0, 0x27, 0x61, 0x53, 0x4a, 0x85, 0x4b, 0x15, 0x1d, 0x41,
     },
     "LTC"},
    // CBYFV4W2LTMXYZ3XWFX5BK2BY255DU2DSXNAE4FJ5A5VYUWGIBJDOIGG
    {{
         0x70, 0x5a, 0xf2, 0xda, 0x5c, 0xd9, 0x7c, 0x67, 0x77, 0xb1, 0x6f,
         0xd0, 0xab, 0x41, 0xc6, 0xbb, 0xd1, 0xd3, 0x43, 0x95, 0xda, 0x02,
         0x70, 0xa9, 0xe8, 0x3b, 0x5c, 0x52, 0xc6, 0x40, 0x52, 0x37,
     },
     "NGNC"},
    // CCFS6UDFSR5OJIN45RQPUCZ5JTTU5TQOTIS6XKYKNWKC4TVR752BOWOF
    {{
         0x8b, 0x2f, 0x50, 0x65, 0x94, 0x7a, 0xe4, 0xa1, 0xbc, 0xec, 0x60,
         0xfa, 0x0b, 0x3d, 0x4c, 0xe7, 0x4e, 0xce, 0x0e, 0x9a, 0x25, 0xeb,
         0xab, 0x0a, 0x6d, 0x94, 0x2e, 0x4e, 0xb1, 0xff, 0x74, 0x17,
     },
     "PEN"},
    ...
    {{
         0x75, 0xaf, 0x65, 0xc4, 0xc5, 0xe6, 0x17, 0x8f, 0x70, 0x21, 0x80,
         0x19, 0xa7, 0x12, 0x56, 0x6a, 0x17, 0xe9, 0xe0, 0x91, 0x11, 0x25,
         0x9b, 0x72, 0x0b, 0x26, 0xde, 0x88, 0x9c, 0x86, 0x69, 0x5c,
     },
     "USDGLO"},
    // CBLV4ATSIWU67CFSQU2NVRKINQIKUZ2ODSZBUJTJ43VJVRSBTZYOPNUR
    {{
         0x57, 0x5e, 0x02, 0x72, 0x45, 0xa9, 0xef, 0x88, 0xb2, 0x85, 0x34,
         0xda, 0xc5, 0x48, 0x6c, 0x10, 0xaa, 0x67, 0x4e, 0x1c, 0xb2, 0x1a,
         0x26, 0x69, 0xe6, 0xea, 0x9a, 0xc6, 0x41, 0x9e, 0x70, 0xe7,
     },
     "USTRY"},
    // CAESLMGW5LYTIEJI7FJHK6SFSWRELLNVX5Q4WR4UZEALMTRWQDBKDPAG
    {{
         0x09, 0x25, 0xb0, 0xd6, 0xea, 0xf1, 0x34, 0x11, 0x28, 0xf9, 0x52,
         0x75, 0x7a, 0x45, 0x95, 0xa2, 0x45, 0xad, 0xb5, 0xbf, 0x61, 0xcb,
         0x47, 0x94, 0xc9, 0x00, 0xb6, 0x4e, 0x36, 0x80, 0xc2, 0xa1,
     },
     "VELO"},
    // CBLLEW7HD2RWATVSMLAGWM4G3WCHSHDJ25ALP4DI6LULV5TU35N2CIZA
    {{
         0x56, 0xb2, 0x5b, 0xe7, 0x1e, 0xa3, 0x60, 0x4e, 0xb2, 0x62, 0xc0,
         0x6b, 0x33, 0x86, 0xdd, 0x84, 0x79, 0x1c, 0x69, 0xd7, 0x40, 0xb7,
         0xf0, 0x68, 0xf2, 0xe8, 0xba, 0xf6, 0x74, 0xdf, 0x5b, 0xa1,
     },
     "XRF"},
    // CBPMFYWP4FFV7PQUYHXJZBXS75EHR6FXYSYEZWH2UM7AUYSKI2Z3PTCG
    {{
         0x5e, 0xc2, 0xe2, 0xcf, 0xe1, 0x4b, 0x5f, 0xbe, 0x14, 0xc1, 0xee,
         0x9c, 0x86, 0xf2, 0xff, 0x48, 0x78, 0xf8, 0xb7, 0xc4, 0xb0, 0x4c,
         0xd8, 0xfa, 0xa3, 0x3e, 0x0a, 0x62, 0x4a, 0x46, 0xb3, 0xb7,
     },
     "XRP"},
