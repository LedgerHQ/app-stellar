...
Due to memory limitations the maximum transaction size is set to 10240 bytes on Ledger devices. This should be sufficient for most usages, including multi-operation transactions up to 35 operations depending on the size of the operations.
